...
"# log1" 
"# log1"  git init git add README.md git commit -m "first commit" git branch -M main git remote add origin https://github.com/rodrigoalcab/log1.git git push -u origin main
"# log1" 
"# log1" 
