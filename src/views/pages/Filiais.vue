          ...
          <CCardBody>
            <CRow>
              <CCol sm="6">
                <CInput label="Nome" />
                <CInput label="Cidade" />
                <CInput label="Endereço" />
              </CCol>
              <CCol sm="6">
                <CInput label="Telefone" />
                <CInput label="CNPJ" />
              </CCol>
            </CRow>
          </CCardBody>
          <CCardFooter style="text-align: right">
            <CButton type="submit" size="sm" color="primary" style="margin: 0 8px 0 8px;"><CIcon name="cil-check-circle"/>Cadastrar</CButton>
            <CButton type="reset" size="sm" color="danger" style="margin: 0 8px 0 8px;"><CIcon name="cil-ban"/>Limpar</CButton>
          </CCardFooter>
        </CCard>
      </CCol>
      <CCol sm="6">
